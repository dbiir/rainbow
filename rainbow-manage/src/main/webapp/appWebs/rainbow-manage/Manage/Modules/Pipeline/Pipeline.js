...
var Pipeline = {
    ...
    Tpls: {
        tplPage: { P: "Modules/Pipeline/tplPage.htm", C: "" },
        tplTableItem: { P: "Modules/Pipeline/tplTableItem.htm", C: "" },
        tplDtl: { P: "Modules/Pipeline/tplDtl.htm", C: "" },
    },
    Load: function () {
        var me = Pipeline;
        try {
        ...
        try {
            ...
            var onShow = function (e) {
                if (me.Datas.PostID != 0) {
                    ...
                    var store = "/rainbow-manage/common/" + no.substr(0, 5) + "/";
                    $("#txtStore").val(store);
                }
            };
