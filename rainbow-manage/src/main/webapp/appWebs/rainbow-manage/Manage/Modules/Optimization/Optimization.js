...
var Optimization = {
    ...
    Tpls: {
        tplPage: { P: "Modules/Optimization/tplPage.htm", C: "" },
        tplContent: { P: "Modules/Optimization/tplContent.htm", C: "" },
    },
    Load: function () {
        var me = Optimization;
        try {
    ...
    doShowDtl: function (aIndex) {
        ...
        try {
            ...
            var aUrl = "detail.htm?time=" + aInfo.time + "&desc=" + aInfo.desc + "&pno=" + me.Datas.CurPipeline.no;
            window.open(aUrl);
        }
        catch (E) {; }
    },
