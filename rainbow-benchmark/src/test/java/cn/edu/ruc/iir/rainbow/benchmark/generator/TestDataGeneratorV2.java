...
import cn.edu.ruc.iir.rainbow.benchmark.generator.DataGeneratorV2;
 ...
 * @Description: To test functions of DataGeneratorV2.java
 * @author: Tao
...
public class TestDataGeneratorV2
{
    ...
    public void TestGenDataBySize() {
        DataGeneratorV2 instance = new DataGeneratorV2(4);
