...
public class CmdEvaluate implements Command
{
    ...
    /**
     *
     * @param params --method local/spark [--master master_hostname] --path_ordered ordered_hdfs_path
     *               --path_unordered unordered_hdfs_path --path_column columns_file
     *               --log_dir log_dir(end with '/') --drop_cache true/false
    ...
    public void execute(Properties params)
    {
        ...
        {
            String orderedPath = params.getProperty("--path-ordered");
            String unorderedPath = params.getProperty("--path-unordered");
            String columnFilePath = params.getProperty("--path-column");
